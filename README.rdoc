...
== Roadmap
 ...
 1. Release: Import repositories and import commits via rake task
 2. Release: View commits, changed files and diffs
 3. Release: Comment lines in the diff and accept / reject a commit, send notification emails
 4. Release: Add users / owner / repository-based access control
 5. Release: Do a merge to somewhere, when commit is accepted
 6. Release: Get a beer.
...
Right now I am approaching Release 1.
